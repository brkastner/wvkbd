...
static struct key keys_full[] = {
  {"Caps", "Caps", 1.5, Mod, CapsLock, .scheme = 1},
...
static struct key keys_cyrillic[] = {
  {"ё", "Ё", 1.5, Code, KEY_GRAVE, .hint_label = "yo"},
  {"я", "Я", 1.0, Code, KEY_Z, .hint_label = "ya"},
  {"е", "Е", 1.0, Code, KEY_T, &layouts[ComposeCyrE], .hint_label = "ye"},
  {"р", "Р", 1.0, Code, KEY_H, .hint_label = "ruh"},
  {"т", "Т", 1.0, Code, KEY_N, .hint_label = "tuh"},
  {"ы", "Ы", 1.0, Code, KEY_S, &layouts[ComposeCyrI], .hint_label = "ih"},
  {"у", "У", 1.0, Code, KEY_E, .hint_label = "ooh"},
  {"и", "И", 1.0, Code, KEY_B, &layouts[ComposeCyrI], .hint_label = "ee"},
  {"о", "О", 1.0, Code, KEY_J, .hint_label = "oh"},
  {"п", "П", 1.0, Code, KEY_G, .hint_label = "puh"},
  {"ш", "Ш", 1.0, Code, KEY_I, .hint_label = "sh"},
  {"щ", "Щ", 1.0, Code, KEY_O, .hint_label = "sh'"},
  {"⌫", "⌫", 2.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"Caps", "Caps", 1.5, Mod, CapsLock, .scheme = 1},
  {"а", "А", 1.0, Code, KEY_F, .hint_label = "a"},
  {"с", "С", 1.0, Code, KEY_C, .hint_label = "suh"},
  {"д", "Д", 1.0, Code, KEY_L, .hint_label = "duh"},
  {"ф", "Ф", 1.0, Code, KEY_A, .hint_label = "fuh"},
  {"г", "Г", 1.0, Code, KEY_U, &layouts[ComposeCyrG], .hint_label = "guh"},
  {"х", "Х", 1.0, Code, KEY_LEFTBRACE, .hint_label = "huh"},
  {"й", "Й", 1.0, Code, KEY_Q, &layouts[ComposeCyrJ], .hint_label = "y"},
  {"к", "К", 1.0, Code, KEY_R, &layouts[ComposeCyrK], .hint_label = "kuh"},
  {"л", "Л", 1.0, Code, KEY_K, &layouts[ComposeCyrL], .hint_label = "luh"},
  {"ж", "Ж", 1.0, Code, KEY_SEMICOLON, .hint_label = "zh"},
  {"э","Э", 1.0, Code, KEY_APOSTROPHE, &layouts[ComposeCyrE], .hint_label = "eh"},
  {"Enter", "Enter", 2.5, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"⇧", "⇫", 2.5, Mod, Shift, .scheme = 1},
  {"з", "З", 1.0, Code, KEY_P, .hint_label = "z"},
  {"ч", "Ч", 1.0, Code, KEY_X, &layouts[ComposeCyrChe], .hint_label = "ch"},
  {"ц", "Ц", 1.0, Code, KEY_W, &layouts[ComposeCyrTse], .hint_label = "ts"},
  {"в", "В", 1.0, Code, KEY_D, .hint_label = "vuh"},
  {"б", "Б", 1.0, Code, KEY_COMMA, .hint_label = "buh"},
  {"н", "Н", 1.0, Code, KEY_Y, .hint_label = "nuh"},
  {"м", "М", 1.0, Code, KEY_V, .hint_label = "muh"},
  {"ю", "Ю", 1.0, Code, KEY_DOT, .hint_label = "yoo"},
  {"ъ", "Ъ", 1.0, Code, KEY_RIGHTBRACE, .hint_label = "hard"},
  {"ь", "Ь", 1.0, Code, KEY_M, .hint_label = "soft"},
  {"⇧", "⇫", 2.5, Mod, Shift, .scheme = 1},
  {"", "", 0.0, Last},
};
